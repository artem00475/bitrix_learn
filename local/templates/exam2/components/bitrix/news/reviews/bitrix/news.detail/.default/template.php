...
<div class="review-block">
	...
	<div style="clear: both;" class="review-img-wrap"><img src="<?if(!$arResult["DETAIL_PICTURE"]):?><?=SITE_TEMPLATE_PATH?>/img/rew/no_photo.jpg<?else: echo $arResult["DETAIL_PICTURE"]["SRC"]; endif?>" alt="img"></div>
</div>
