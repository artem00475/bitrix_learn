...
<div class="slide-one-item home-slider owl-carousel">
	<?foreach($arResult["ITEMS"] as $arItem):?>
		...
		<div class="site-blocks-cover" style="background-image: url(<?if($arParams["DISPLAY_PICTURE"]!="N" && is_array($arItem["PREVIEW_PICTURE"])):?><?=$arItem["PREVIEW_PICTURE"]["SRC"]?><?endif?>);" data-aos="fade" data-stellar-background-ratio="0.5">
