			...
			<div class="row">
				<?foreach($arResult["ITEMS"] as $arItem):?>
					...
					<div id="<?=$this->GetEditAreaId($arItem['ID']);?>" class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="100">
						<a href="<?=$arItem["DETAIL_PAGE_URL"]?>"><img src="<?if($arParams["DISPLAY_PICTURE"]!="N" && is_array($arItem["PREVIEW_PICTURE"])):?><?=$arItem["PREVIEW_PICTURE"]["SRC"]?><?endif?>" alt="Image" class="img-fluid"></a>
